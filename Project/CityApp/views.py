...
def executekmeansmodel(request):
    ...
    try:
        ...
        # age = (m.get('Age2034'))  
        # #print(age)
        # AvgProp=(m.get('AvgPropTaxPerCap'))
        # Bet10and14=(m.get('Bet10and14'))
        # Bet5and9=(m.get('Bet5and9'))
        # Bet65and74  = (m.get('Bet65and74'))
        # LandArea = (m.get('LandArea'))
        # Net25and34 = (m.get('Net25and34'))
        # Under5 = (m.get('Under5'))
        # CorpTaxMin = (m.get('CorpTaxMin'))
        # CorpTaxMax = (m.get('CorpTaxMax'))
        # CO2Index = (m.get('CO2Index'))
        # TotEnrollment = (m.get('TotEnrollment'))
        # PercentBach = (m.get('PercentBach'))
        # LaborForceAnnGrowth = (m.get('LaborForceAnnGrowth'))
        # PropPricetoIncomeRatio = (m.get('PropPricetoIncomeRatio'))
        # CostLivingComposit = (m.get('CostLivingComposit'))
        # NumAirline = (m.get('NumAirline'))
        # TrafficIndex = (m.get('TrafficIndex'))
        # GDPperCap = (m.get('GDPperCap'))
        # GDP5Year = (m.get('GDP5Year'))
        # MedianIncome = (m.get('MedianIncome'))
        # CPIIndex = (m.get('CPIIndex'))
        #m = json.dumps(m)
        # for key in m:
        #     print(value[1])
        ...
        path2script ='/home/bitnami/Project/CityApp/KNN_4wt.R'
